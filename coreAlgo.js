...
var assetDistributionList = [
    Object.freeze({ allowed: checkboxes[0].checked, value: 100.0, distribution: 12.56 }),
    Object.freeze({ allowed: checkboxes[1].checked, value: 50.0, distribution: 47.0 }),
    Object.freeze({ allowed: checkboxes[2].checked, value: 20.0, distribution: 17.66 }),
    Object.freeze({ allowed: checkboxes[3].checked, value: 10.0, distribution: 11.87 }),
    Object.freeze({ allowed: checkboxes[4].checked, value: 5.0, distribution: 9.01 }),
    Object.freeze({ allowed: checkboxes[5].checked, value: 2.0, distribution: 0.097 }),
    Object.freeze({ allowed: checkboxes[6].checked, value: 1.0, distribution: 0.109 }),
    Object.freeze({ allowed: checkboxes[7].checked, value: 0.5, distribution: 0.094 }),
    Object.freeze({ allowed: checkboxes[8].checked, value: 0.2, distribution: 0.179 }),
    Object.freeze({ allowed: checkboxes[9].checked, value: 0.1, distribution: 0.229 }),
    Object.freeze({ allowed: checkboxes[10].checked, value: 0.05, distribution: 0.325 }),
    Object.freeze({ allowed: checkboxes[11].checked, value: 0.02, distribution: 0.418 }),
    Object.freeze({ allowed: checkboxes[12].checked, value: 0.01, distribution: 0.537 }),
];
